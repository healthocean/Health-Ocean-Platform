...
const seedDatabase = async () => {
  try {
    ...
    const standardTests = [
      ...
      { name: 'Lung Function: IgE Total', cat: 'Allergy Tests', p: 600, op: 850, organ: 'Lung', gender: 'Both', age: 'All Ages', prep: false },
      { name: 'Respiratory Panel: Allergy Screen', cat: 'Allergy Tests', p: 3500, op: 5000, organ: 'Lung', gender: 'Both', age: 'All Ages', prep: false },
      ...
      { name: 'Vitamin D (25-OH) Total', cat: 'Hair & Skin', p: 1100, op: 1600, organ: 'Joint', gender: 'Both', age: 'All Ages', prep: false },
      { name: 'Calcium & Bone Health Screen', cat: 'Hair & Skin', p: 400, op: 600, organ: 'Joint', gender: 'Both', age: 'All Ages', prep: false },
      ...
      { name: 'Arthritis Profile Comprehensive', cat: 'Full Body Checkups', p: 1800, op: 2500, organ: 'Joint', gender: 'Both', age: 'Adults', prep: false },
